...
exports.LocationParseError = void 0;
...
exports.LocationParseError = LocationParseError;
...
async function normalizeLocation(location) {
    try {
        ...
        if (!match) {
            throw new LocationParseError('Invalid location format. Expected format: "<county> county, <state>"');
        }
        ...
        logger_1.logger.info("Location normalized successfully", {
            input: location,
            normalized,
        });
        return normalized;
        ...
        logger_1.logger.error("Unexpected error in location normalization", {
            input: location,
...
//# sourceMappingURL=dataNormalization.js.map