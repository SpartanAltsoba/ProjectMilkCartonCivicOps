    ...
    try {
        switch (req.method) {
            case "GET":
                ...
                const foiaRequests = await db_1.prisma.foiaRequest.findMany({
            ...
            case "POST":
                ...
                const newFOIARequest = await db_1.prisma.foiaRequest.create({
                    data: {
                        title,
                        description,
                        status: "Pending",
            ...
            case "PUT":
                ...
                const updatedFOIARequest = await db_1.prisma.foiaRequest.update({
                    where: { id },
                    data: updateData,
                });
