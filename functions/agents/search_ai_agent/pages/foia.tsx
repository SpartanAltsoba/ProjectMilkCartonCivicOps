...
const FOIA: NextPage<FOIAProps> = ({ requests, error }) => {
  return (
    <>
      ...
      <Header title="Civic Trace Ops - FOIA Requests" navigationLinks={['/', '/dashboard', '/about']} />
      ...
      <Footer contactInfo={{ email: 'support@civictraceops.com', phone: '123-456-7890' }} socialLinks={['facebook', 'twitter', 'linkedin']} />
    </>
  );
};
