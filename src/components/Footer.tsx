    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-lg font-semibold mb-4">About CIVIC TRACE OPS</h3>
            <p className="text-gray-300 text-sm leading-relaxed">
              A platform dedicated to investigating, mapping, and reporting on child welfare systems
              through data-driven analysis and automated tools.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/foia" className="text-gray-300 hover:text-white text-sm">
                  FOIA Generator
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-2">
              <p className="text-gray-300 text-sm">support@civictraceops.org</p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} CIVIC TRACE OPS. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
